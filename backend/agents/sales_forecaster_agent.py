...
class SalesForecasterAgent(EnhancedBaseAgent):
    """
    Sales Forecaster Agent
    Category: Retail
    Description: Forecasts sales
    """

    def __init__(self):
        super().__init__()
        self.name = "Sales Forecaster"
        self.description = "Forecasts sales"
        self.agent_id = "sales_forecaster"
        self.category = "Retail"
        self.version = "1.0.0"

        self.capabilities = ['sales_forecasting', 'trend_analysis', 'scenario_modeling']
        self.tools = {}
    ...
    def register_tools(self) -> None:
        ...
        self.tools = {'forecast_sales': {'description': '', 'params': {}}, 'analyze_trend': {'description': '', 'params': {}}, 'model_scenario': {'description': '', 'params': {}}}
