"""
Expense Categorizer Agent - Finance
Automatically categorizes expenses and generates analytics
"""
import logging
...
class ExpenseCategorizerAgent(EnhancedBaseAgent):
    """
    Expense Categorizer Agent
    Category: Finance
    Description: Automatically categorizes expenses and generates analytics
    """

    def __init__(self):
        super().__init__()
        self.name = "Expense Categorizer"
        self.description = "Automatically categorizes expenses and generates analytics"
        self.agent_id = "expense_categorizer"
        self.category = "Finance"
        self.version = "1.0.0"

        self.capabilities = ['auto_categorization', 'expense_analysis', 'spending_insights']
        self.tools = {}
    ...
    def register_tools(self) -> None:
        ...
        self.tools = {'categorize_expense': {'description': '', 'params': {}}, 'analyze_spending': {'description': '', 'params': {}}, 'detect_anomaly': {'description': '', 'params': {}}}
