...
class TripPlannerAgent(EnhancedBaseAgent):
    """
    Trip Planner Agent
    Category: Travel
    ...
    def __init__(self):
        super().__init__()
        self.name = "Trip Planner"
        self.description = "Plans trips"
        self.agent_id = "trip_planner"
        self.category = "Travel"
        self.version = "1.0.0"

        self.capabilities = ['itinerary_planning', 'budget_optimization', 'recommendation_engine']
        self.tools = {}
    ...
    def register_tools(self) -> None:
        ...
        self.tools = {'create_itinerary': {'description': '', 'params': {}}, 'optimize_budget': {'description': '', 'params': {}}, 'recommend_activities': {'description': '', 'params': {}}}
