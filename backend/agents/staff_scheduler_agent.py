...
class StaffSchedulerAgent(EnhancedBaseAgent):
    """
    Staff Scheduler Agent
    Category: Retail
    Description: Schedules staff
    """

    def __init__(self):
        super().__init__()
        self.name = "Staff Scheduler"
        self.description = "Schedules staff"
        self.agent_id = "staff_scheduler"
        self.category = "Retail"
        self.version = "1.0.0"

        self.capabilities = ['scheduling', 'labor_forecasting', 'shift_optimization']
        self.tools = {}
    ...
    def register_tools(self) -> None:
        ...
        self.tools = {'create_schedule': {'description': '', 'params': {}}, 'forecast_labor': {'description': '', 'params': {}}, 'optimize_shifts': {'description': '', 'params': {}}}
